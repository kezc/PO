...
void Konsola::wypiszObiektyZAktualnegoWezla() {
...
void Konsola::utworzObiektDlaAktualnegoLiscia() {
    std::string nazwa;
    std::cin >> nazwa;
...
void Konsola::wypiszSzczegolyDlaObiektuZLiscia() {
    std::string nazwa;
    std::cin >> nazwa;
//
//        bool found = false;
...
void Konsola::modyfikujObiektZLiscia() {
    std::string nazwa;
    std::cin >> nazwa;
    switch (aktualnyWezel) {
        case Wezel::Rownoboczny:
...
void Konsola::usunObiektZLiscia() {
    std::string nazwa;
    std::cin >> nazwa;
    bool usunieto;
    switch (aktualnyWezel) {
...
void Konsola::dodajOstroslupCzworokatnyPrawidlowy(std::string &nazwa) {
...
void Konsola::dodajRownoboczny(std::string &nazwa) {
...
void Konsola::dodajInneTrojkaty(std::string &nazwa) {
...
void Konsola::dodajOstroslupTrojkatnyPrawidlowy(std::string &nazwa) {
...
void Konsola::dodajInneCzworokaty(std::string &nazwa) {
...
std::string Konsola::aktualnyWezelJakoString() {
    switch (aktualnyWezel) {
        case Wezel::FiguryGeometryczne:
...
FiguryGeometryczne *Konsola::znajdzFigure(std::string &nazwa) {
...
void Konsola::odczytajZPliku(std::string &nazwaPliku) {
    std::ifstream plik;
...
void Konsola::zapiszDoPliku(std::string &nazwa) {
    std::ofstream plik;
    plik.open(nazwa);
    std::vector<FiguryGeometryczne *> *liscie = getLiscie();
    for (auto element : *liscie) {
...
std::vector<FiguryGeometryczne *> *Konsola::getLiscie() {
...
std::vector<Punkt<double> *> *Konsola::getLisciePunkt() {
...
std::vector<Trojkat *> *Konsola::getLiscieTrojkat() {
    std::set<Trojkat *> set;
    for (auto element : Rownoboczny::liscie) set.insert(element);
    for (auto element : InneTrojkaty::liscie) set.insert(element);
    for (auto element : OstroslupTrojkatnyPrawidlowy::liscie) set.insert(element);
...
std::vector<Czworokat *> *Konsola::getLiscieCzworokat() {
...
std::vector<Kwadrat *> *Konsola::getLiscieKwadrat() {
